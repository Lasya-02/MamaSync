...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://127.0.0.1:3000","http://127.0.0.1:8000","http://54.197.27.81",  # optional if accessing by IP
        "http://ec2-54-197-27-81.compute-1.amazonaws.com","*"],
